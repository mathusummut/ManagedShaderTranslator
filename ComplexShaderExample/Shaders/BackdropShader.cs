...
using ComplexShaderExample.Textures;
using IIS.SLSharp.Shaders;
using OpenTK;

namespace ComplexShaderExample.Shaders {
	public abstract class BackdropShader : Shader {
		...
		protected BackdropShader() {
			...
			var bmp = ComplexShaderExample.Properties.Resources.tiles;
