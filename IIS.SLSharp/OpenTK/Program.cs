...
namespace IIS.SLSharp.Bindings.OpenTK
{
    sealed class Program: IProgram
    {
        ...
        private void Validate()
        {
            ...
            GL.GetProgram(Name, GetProgramParameterName.LinkStatus, out linkStatus);
            GL.GetProgram(Name, GetProgramParameterName.ValidateStatus, out validStatus);
        ...
        {
            int length;
            GL.GetProgram(Name, GetProgramParameterName.ProgramBinaryLength, out length);
